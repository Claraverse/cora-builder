...
class Clara_Impact_Testimonial extends Base_Widget
{
    ...
    {
        return 'clara_impact_testimonial';
    }
    public function get_title()
    {
        return __('Clara Impact & Testimonial', 'clara-builder');
    }
