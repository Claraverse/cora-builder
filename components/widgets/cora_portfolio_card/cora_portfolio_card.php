...
class Cora_Portfolio_Card extends Widget_Base
{
    ...
    {
        return 'cora_portfolio_card';
    }
    public function get_title()
    {
        return __('Cora Portfolio Card', 'cora-builder');
    }
    ...
    protected function render()
    {
        ...
        <style>
            ...
            .cpc-gallery-wrap::-webkit-scrollbar {
                display: none;
            }
            ...
            .cpc-gallery-track {
                ...
                width: max-content;
                pointer-events: none;
                /* Let clicks pass through to parent for drag logic */
            }
            ...
            .cpc-shot-frame {
                background:
                    <?php echo esc_attr($settings['accent_color']); ?>
                ;
                border-radius: 20px;
                padding: 0;
                width: 450px;
