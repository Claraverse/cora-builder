	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'description' => 'Enter the ID of the post you want to display.',
	...
	protected function render() {
		...
		if ( $query->have_posts() ) {
			...
			if ( \Elementor\Plugin::$instance->editor->is_edit_mode() ) {
				echo '<div class="cora_alert">No posts found. Please check your Query settings.</div>';
			}
		}
	}
}